...
{
	/// <summary>
	/// Provides extension methods for <see cref="MutableDisposable"/>.
	/// </summary>
	public static class MutableDisposableExtensions
	{
		...
		/// to the <see cref="MutableDisposable.Disposable"/> property of the specified <paramref name="disposable"/>.
		/// </summary>
		/// <remarks>
		/// The double-indirection pattern avoids a race condition that can occur when the <paramref name="factory"/> 
		/// has a side-effect that causes the <see cref="MutableDisposable.Disposable"/> property of the specified 
